...
<template>
  <div>
    ...
    <TitleContent
      ...
      class="-mt-8 mb-4 md:text-large text-light"
    >
      <Fieldset legend="Datos Personales" class="mb-3 pr-5">
        <div class="grid">
          ...
          <div class="col-12 md:col-6 mt-1">
            ...
            > -->
            <div class="grid">
              <div class="col-12 md:col-4 md:gap-2 md:ml-5 ml-0">
                <p class="mt-2 pl-0">Va con acompañante?</p>
              </div>
      ...
      >
        <div class="grid">
          ...
          <div class="col-12 md:col-6 mt-1">
            ...
            <small
              v-if="
                isInvalid(v$.acompanante.correo) && !form.acompanante.correo
              "
              class="p-error"
            >
          ...
          <div class="col-12 md:col-6 mt-1">
            <div class="p-inputgroup p-float-label flex flex-column">
              <InputText
                ...
                class="w-full"
                :class="{
                  'p-invalid': isInvalid(v$.contactoEmergencia.nombre),
                }"
              />
              <label
            ...
            <small
              v-if="isInvalid(v$.contactoEmergencia.nombre)"
              class="p-error"
            >
          ...
          <div class="col-12 md:col-6 mt-1">
            <div class="p-inputgroup p-float-label flex flex-column">
              ...
              <label
                ...
                :class="{
                  'p-error': isInvalid(v$.contactoEmergencia.telefono),
                }"
              >
                Teléfono Contacto
              </label>
