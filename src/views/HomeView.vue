  ...
  <div>
    ...
    <div class="grid px-5 py-5 md:w-9 w-full mx-auto margen shadow-1">
      ...
      <div class="col-12 px-3 bg-white mt-0 grid">
        ...
        >
          <p>
            <span class="md:pl-5 pl-3 mt-0">Queridas</span> Asociadas y
            Asociados, la Comisión Organizadora de la Convención Anual de
            Magistradas y Magistrados de la Región de Los Lagos, está feliz de
            invitarlos a reencontrarnos después de dos años de Pandemia en la
            ciudad de las rosas, Puerto Varas, desde el 30 de noviembre al 3 de
            diciembre del presente año. Con mucho cariño hemos preparado
            actividades en los más hermosos parajes de nuestras zonas y
            prometemos, además, momentos inolvidables de fraterno trabajo
            gremial y por supuesto la mejor entretención.
          </p>
    ...
    <main id="programa" class="md:px-8 px-0 pt-5 md:py-5">
      <div class="col-12 text-center">
        ...
        <div class="text-center my-5">
          <p class="text-white md:px-8 px-4 md:mx-8">
